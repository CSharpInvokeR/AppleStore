...
namespace AppleStore.Pages.ManagerPages
{
    public partial class ManagerReportsPage : Page
    {
        public ManagerReportsPage()
        {
            ...
            btnProductsReport.Click += btnProductsReport_Click;
            btnCustomersReport.Click += btnCustomersReport_Click;
        }
        ...
        private void btnProductsReport_Click(object sender, RoutedEventArgs e)
        {
